"""Operations package initializer: exposes arithmetic helpers for the app."""
# This file is called "operations.py"
# It contains four simple math functions: addition, subtraction, multiplication, and division.
...
def addition(a: float, b: float) -> float:
    ...
    return (
        a + b
    )  # This is the actual math part: we add the two numbers together and return the result.
...
def subtraction(a: float, b: float) -> float:
    ...
    return (
        a - b
    )  # This subtracts the second number (b) from the first number (a) and returns the result.
